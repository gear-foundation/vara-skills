...
- Need a new React frontend from scratch: `npx create-vara-app <name> --idl <idl-path>`, then `../sails-frontend/SKILL.md` for customization
- Need to extend or repair an existing React or TypeScript frontend for a Sails app: `../sails-frontend/SKILL.md`
