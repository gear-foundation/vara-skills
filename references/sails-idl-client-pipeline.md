...
3. Generate the TypeScript client: `npx sails-js-cli generate frontend/src/assets/program.idl -o frontend/src/lib --no-project` or `cargo sails client-js <idl_path> <out_path>`.
