...
4. Install the Sails Rust CLI with `cargo install sails-cli --locked`, which provides `cargo-sails` and the standard greenfield bootstrap command `cargo sails program <project-name>`.
